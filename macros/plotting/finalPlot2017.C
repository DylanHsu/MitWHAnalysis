void finalPlot2017(
  ...
  TH1D *histo_Zjets = (TH1D*) f->Get(Form("%s/%s/%s/Cont. Z+jets", plotName.Data(), jetString.Data(), lepString.Data());
  ...
  if(!isBlind || selection!="sigsel") histo_data->Draw("E X0 P SAME");
  TString title;
  ...
  else         { l1 = new TLegend(0.57,0.6,0.75,0.88); l2 = new TLegend(0.77,0.66,0.95,0.88); }
  l1->SetFillColor(0);
  l1->SetBorderSize(0);
  l2->SetFillColor(0);
  l2->SetBorderSize(0);
  ...
  l2->AddEntry(histo_Zjets , "Cont. Z+jets"      , "f");
